# Word Lexicon Analyzer Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:lexicon-api:1.1.13'
}
```
...
```java
import com.apiverve.lexicon.WordLexiconAnalyzerAPIClient;
import com.apiverve.lexicon.APIResponse;
import com.apiverve.lexicon.APIException;

// Initialize the client
WordLexiconAnalyzerAPIClient client = new WordLexiconAnalyzerAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/lexicon](https://docs.apiverve.com/ref/lexicon)
...
- **Documentation:** [https://docs.apiverve.com/ref/lexicon](https://docs.apiverve.com/ref/lexicon)
- **Issues:** [GitHub Issues](https://github.com/apiverve/lexicon-api/issues)
