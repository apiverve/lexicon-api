...
/**
 * Client for the Word Lexicon Analyzer API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/lexicon?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/lexicon';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\LexiconClient] {$message}\n";
        }
    }
}
