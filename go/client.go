...
const (
	baseURL        = "https://api.apiverve.com/v1/lexicon"
	defaultTimeout = 30 * time.Second
)

// Client is the Word Lexicon Analyzer API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Word Lexicon Analyzer API client.
...
// Execute makes a request to the Word Lexicon Analyzer API with typed parameters.
//
