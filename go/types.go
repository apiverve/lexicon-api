// Package lexicon provides a Go client for the Word Lexicon Analyzer API.
//
// For more information, visit: https://apiverve.com/marketplace/lexicon?utm_source=go&utm_medium=readme
package lexicon
...
// Request contains the parameters for the Word Lexicon Analyzer API.
//
// Parameters:
//   - word (required): string - The word to analyze
type Request struct {
...
// ResponseData contains the data returned by the Word Lexicon Analyzer API.
type ResponseData struct {
	Word string `json:"word"`
	IsAlphagram bool `json:"isAlphagram"`
	SortedForm string `json:"sortedForm"`
	IsPalindrome bool `json:"isPalindrome"`
	HasAnagram bool `json:"hasAnagram"`
	IsIsogram bool `json:"isIsogram"`
	IsPangramCandidate bool `json:"isPangramCandidate"`
	IsScrabbleValid bool `json:"isScrabbleValid"`
	CanBePalindromeAnagram bool `json:"canBePalindromeAnagram"`
}
