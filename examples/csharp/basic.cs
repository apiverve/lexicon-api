...
{
    class WordLexiconAnalyzerExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/lexicon";

        /// <summary>
        /// Make a GET request to the Word Lexicon Analyzer API
        /// </summary>
        static async Task<JsonDocument> CallWordLexiconAnalyzerAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;word&quot;] &#x3D; &quot;listen&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Word Lexicon Analyzer API...\n");

            var result = await CallWordLexiconAnalyzerAPI();
